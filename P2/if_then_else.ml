(*Debemos hacer un cambio en la expresión de las siguientes líneas de Ocaml del siguiente tipo:*)
...
(function true -> ((fucntion true -> x | false -> z) (x > z)) | false -> ((funtion true -> y | false -> z) (y > z))) (x > y);;
